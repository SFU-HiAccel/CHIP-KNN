...
# Funtion usage: "Interpolate_Bandwidth("DDR4", 512, 131072)"
'''
# _memory_type: "DDR4" or "HBM2"
# _port_width: #bit (32 - 512)
# _buf_size: #byte (1024 - 1048576)
'''
def Interpolate_Bandwidth( _memory_type, _port_width, _buf_size ):
    port_width_list = [32, 64, 128, 256, 512] # bits (32bit-512bit)
    buf_size_list = [1024, 2048, 4096, 8192, 16384, \
                      32768, 65536, 131072, 262144, \
                      524288, 1048576] # bytes (1KB-1MB)

    DDR4_BW = [[0.89641, 1.03359, 1.11266, 1.15395, 1.17445, 1.18558, 1.19158, 1.19440, 1.19575, 1.19661, 1.19696], \
    ...
    HBM2_BW = [[0.94898, 1.03389, 1.12187, 1.16194, 1.17894, 1.18997, 1.19479, 1.19746, 1.19867, 1.19937, 1.19966], \
...
def Theoretical_Bandwidth (_memory_type, _port_width):
    ...
    theoretical_bw = max_bw * (float(_port_width)/512.0)
